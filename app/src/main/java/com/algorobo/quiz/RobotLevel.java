...
public class RobotLevel {
    ...
    public static List<Level> buildLevels() {
        ...
        l2p.add(new Item("电机应用（旋转、往复、摇摆动作）"));
        l2.add(l2p);
        ...
        l3k.add(new Item("电流、电压、电阻、欧姆定律、导体、半导体"));
        l3k.add(new Item("串联与并联"));
        l3k.add(new Item("二极管特性"));
        l3k.add(new Item("控制系统工作流程"));
        l3k.add(new Item("模拟量、数字量、I/O口输入输出"));
        l3k.add(new Item("图形化编程软件使用"));
        l3k.add(new Item("图形化编程三种基本结构、变量"));
        l3k.add(new Item("图形化编程数学、比较、逻辑运算"));
        ...
        l3p.add(new Item("超声波传感器、舵机、红外遥控器"));
        ...
        l4k.add(new Item("细分领域机器人理论及前沿时事"));
        l4k.add(new Item("二进制、十进制、十六进制转换"));
        l4k.add(new Item("上拉电阻、下拉电阻"));
        l4k.add(new Item("模拟量、数字量、I/O口输入输出"));
        l4k.add(new Item("程序设计三种基本结构、自定义函数"));
        l4k.add(new Item("变量及变量作用域"));
        l4k.add(new Item("数学、比较及逻辑运算"));
        l4k.add(new Item("直流电机运动控制、伺服电机（舵机）控制"));
        ...
        l4k.add(new Item("自律型（反馈型）机器人行动方式"));
        l4.add(l4k);
        Section l4p = new Section("机器人搭建");
        l4p.add(new Item("数字信号传感器（灰度、接近开关、触碰）"));
        l4p.add(new Item("模拟信号传感器（光线强度）"));
        l4p.add(new Item("数字脉冲信号传感器（超声波、红外遥控）"));
        l4p.add(new Item("控制器I/O口数字/模拟信号读写"));
        l4p.add(new Item("编程控制伺服电机（舵机）"));
        l4p.add(new Item("编程控制机器人平台移动"));
        l4p.add(new Item("三极管控制电路通断"));
        l4p.add(new Item("自律型机器人制作（自动跟随、避障、单线条巡线）"));
        l4.add(l4p);
        levels.add(l4);
        ...
        l5k.add(new Item("集成电路、微控制器（产品、工程、时事）"));
        ...
        l5p.add(new Item("UART数据通信（蓝牙、计算机）"));
        ...
        l8p.add(new Item("非特定语音控制、网络语音信息处理"));
